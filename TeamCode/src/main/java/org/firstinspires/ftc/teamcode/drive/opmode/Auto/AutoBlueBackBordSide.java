...
/*        TrajectorySequence leftProp = drive.trajectorySequenceBuilder(new Pose2d())
        ...
        //--------------------------
        //---------------------------
        TrajectorySequence leftPropStart = drive.trajectorySequenceBuilder(new Pose2d(15, 70, Math.toRadians(-90)))
                .lineToLinearHeading(new Pose2d(15, 45, Math.toRadians(-130)))
                .build(); // to prop line
        TrajectorySequence rightPropStart = drive.trajectorySequenceBuilder(new Pose2d(15, 70, Math.toRadians(-90)))
                .lineToLinearHeading(new Pose2d(23, 52, Math.toRadians(-90)))
                .build(); // to prop line
        TrajectorySequence midPropStart = drive.trajectorySequenceBuilder(new Pose2d(15, 70, Math.toRadians(-90)))
        ...
        TrajectorySequence midGetMoreFromStack = drive.trajectorySequenceBuilder(midPropToBkB.end())
                .splineTo(new Vector2d(0, 11.5), Math.toRadians(180))
                .splineTo(new Vector2d(-50, 11.5), Math.toRadians(180))
                .waitSeconds(2) // taking from stack
                .lineToConstantHeading(new Vector2d(0, 11.5))
                .splineTo(new Vector2d(38, 32), Math.toRadians(0))
                .addDisplacementMarker(()->{
                    // put on back bord
